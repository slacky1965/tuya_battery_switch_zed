...
> [!WARNING]
> Пока все сделано только для 4-х кнопочного выключателя. Поэтому описание пока будет под него. Работа над остальными выключателями и выключателями в процессе.
>
